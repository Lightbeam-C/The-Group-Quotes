...
export default function Home() {
    ...
    const people = ['All Categories', 'Inspiration', 'Humor', 'Philosophy'];
    ...
    const handleTextareaChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        // 2. Set the height to match the internal content size
                    ...
                    <div className="flex flex-row w-full">
                        ...
                        <div className='w-40 h-[37px]'>
                            <div className="relative w-30">
                                ...
                                >
                                    <span className="truncate">{selected || whoPlaceholder}</span>
                                    <ChevronDown
                                    color='white'
                                    size={16}
                                ...
                                {isOpen && (
                                    ...
                                    <div className="max-h-60 overflow-y-auto">
                                        ...
                                        <button
                                            ...
                                            className="w-full text-left px-4 py-2 text-sm text-slate-300 hover:bg-blue-4    00 hover:text-white transition-colors"
                                        >
                                            {option}
                                        </button>
                                        ))}
